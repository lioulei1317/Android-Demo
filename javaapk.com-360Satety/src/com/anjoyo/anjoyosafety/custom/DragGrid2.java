 ...
 *
 */
public class DragGrid2 extends GridView 
{
	/**长按选项的位置**/
	...
	public DragGrid2(Context context, AttributeSet attrs) 
	{
		super(context, attrs);	
		this.mContext=context;
	}

	public DragGrid2(Context context) 
	{
		super(context);
		this.mContext=context;
	}
...
//				    	specialPosition = -1;			    
	...
	public  void OnMove(int x, int y)
	{
		...
		if(MoveNum != 0)
		{
			...
			final MainGridViewAdapter2 adapter = (MainGridViewAdapter2)this.getAdapter();
