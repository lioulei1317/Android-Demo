...
import com.jarvis.myyiqugou.gouwuche.AllBaby_F;
import com.jarvis.myyiqugou.gouwuche.LowBaby_F;
import com.jarvis.myyiqugou.gouwuche.StockBaby_F;
 ...
 * 
 */
public class ViewPager005_ThridFragment extends Fragment implements
		OnClickListener {
	Context context;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = LayoutInflater.from(context).inflate(R.layout.cart_f, null);
		initView(view);
		return view;
	}

	private void initView(View view) {
		((TextView) view.findViewById(R.id.tv_top_txtTitle)).setText("购物车");
	...
	public void onClick(View v) {
		...
		case R.id.bt_cart_all:
			...
			show_cart_all.setBackgroundColor(getResources().getColor(
					R.color.bg_Black));
			show_cart_low.setBackgroundColor(getResources().getColor(
					R.color.bg_Gray));
			show_cart_stock.setBackgroundColor(getResources().getColor(
					R.color.bg_Gray));
			break;
